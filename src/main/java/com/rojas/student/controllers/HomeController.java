package com.rojas.student.controllers;

import com.rojas.student.models.*;
...
public class HomeController {
    ...
    void agregarAction(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/rojas/student/crear-view.fxml"));
